    ...
    <>
      ...
      <section className="py-20 px-4 bg-[#f9e1db] text-[#7f4f63]">
        <div className="max-w-xl mx-auto text-center">
          ...
          <form onSubmit={handleNewsLetterData} className="flex gap-2">
            ...
            <button
              type="submit"
              className="px-6 py-3 bg-[#B76E79] text-white rounded-full hover:bg-[#7f4f63] transition-colors"
            >
              Subscribe
            </button>
          </form>
      ...
      <footer className="bg-[#f1e0da] py-12 px-4 text-[#7f4f63]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Facebook', 'Instagram', 'Pinterest'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-[#7f4f63] hover:text-[#B76E79] transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <p className="text-[#7f4f63]">
              Email: hello@tailorzone.com<br />
              Phone: (555) 123-4567
            </p>
          </div>
        </div>
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-[#B76E79] text-center text-[#7f4f63]">
      ...
      {openPopup && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-[#f9e1db] text-[#7f4f63] p-6 rounded-lg shadow-lg">
